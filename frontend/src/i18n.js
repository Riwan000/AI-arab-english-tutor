...
const STRINGS = {
  ar: {
    ...
    type_instead_label: "اكتب بدلاً من ذلك",
    mic_permission_error: "تعذّر الوصول إلى الميكروفون.",
    mic_transcribe_error: "تعذّر فهم الصوت. حاول مرة أخرى.",
    ...
    resume_prompt_message: "هل تريد استكمال محادثتك السابقة؟",
    resume_button: "استكمال",
    start_fresh_button: "بدء محادثة جديدة",
    session_ending_notice: "جارٍ إنهاء الجلسة...",
  },
  en: {
    ...
    type_instead_label: "Type instead",
    mic_permission_error: "Couldn't access the microphone.",
    mic_transcribe_error: "Couldn't hear that — try again.",
    ...
    resume_prompt_message: "Resume your last conversation?",
    resume_button: "Resume",
    start_fresh_button: "Start Fresh",
    session_ending_notice: "Wrapping up this session...",
  },
};
